...
The techniques that were used in this project was techninaues such as sprints. Sprints are a period of time that contains the SCRUM events and activities. these Sprints are contained for a number of days until they end. Another technique was testing. Testing is just using the application for it designed goal and making sure that it works for that goal taking notes and making changes after testing. Another technique that was used during the development of the project was review meetings. These meetings are when the client and developers meet to discuss the direction the application is going in and suggest changes to each other to better aim the application to its goal.
