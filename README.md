...
## client meetup
during thsi poject we had a meeeting with the client. we made our way to the client in October to discuess what the project will unclude. we disscused what changes needed to be made to the project to better suit the clients idea. This was done so that the finnished product was the best that we could do for the clients needs. We interviwed the client to get their input on the project and to see if our project was lining up with their needs. later on in the project we showed them a prototype of the game to show the techiques and ideas that was put into the project.
## tools used
there were many diffrent tools used to communicate with the client and create the project. thse include software such as text editors (Microsoft word), presentation editors (microsoftpowerpoinnt), image editing software (photoshop) and unity to create the game.
